# -*- coding: utf-8 -*-
"""
Created on Tue Jun  9 15:21:02 2026
...
class Pixis(QtCore.QThread):
    ...
    def calculate_wavelength_array(self,center_wavelength_nm,grating_lines_per_mm):
        ...
        if calibrated:
            ...
            #f, delta, gamma, n0, offset_adjust, d_grating, x_pixel, curvature = [np.float64(0.0014950942168328425), np.float64(-9.42477790474566), np.float64(45.79048877897811), np.float64(469.0), 0, 4926.108374384236, 24000.0, np.float64(-8.220231991669644e-05)]
            #f, delta, gamma, n0, offset_adjust, d_grating, x_pixel, curvature = [np.float64(164938020.34690526), np.float64(0.9873449482229446), np.float64(0.5120816417084556), np.float64(521.75), 0, 833.3333333333334, 26000.0, np.float64(6.33162619074244e-06)]
            f, delta, gamma, n0, offset_adjust, d_grating, x_pixel, curvature =[np.float64(300000000.0), np.float64(0.06), np.float64(0.5), np.float64(516.6), 0, 833.3333333333334, 26000.0, np.float64(0.0)]
