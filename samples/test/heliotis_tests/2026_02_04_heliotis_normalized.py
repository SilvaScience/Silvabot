...
# %%
# input 
date = '2026-02-04' # '2025-07-24' # 
bg_name =  'avg_data17_09_34' # 1999Hz: avg_data15_55_19, 499Hz: avg_data15_32_59, 1999 Hz+AC: avg_data16_55_37
N_period = 100
freq = 1999
...
# %% stich several maps
filenames=['raw_data17_08_39'] # 50 53 57  # 1999Hz : raw_data15_56_53, 499Hz: raw_data15_34_30, 1999 Hz+AC: raw_data16_56_03
maps = {}
rawI = {}
rawQ = {}
amp = {}
...
bg_file = 'avg_data18_46_29'

with h5py.File(os.path.join(path,date,bg_name + '.h5'), 'r') as f:
    bg_rawI = f['averaged_rawI'][:,:] # 264:268
    bg_rawQ = f['averaged_rawQ'][:,:]

bg_file2 = 'avg_data18_45_39'
