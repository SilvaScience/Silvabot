...
# %%
# input 
date = '2025-09-23' # '2025-07-24' # 
data_name =  'GaAs_QW_2501_17_10_41' # 'GaAs_QW_2501_16_08_00' #
...
# filter FT spectrum
crit_min = find_idx(freqs_crop,0.031) #0.006  #0.06 #0.18
...
plot_external = False
if plot_external:
    data_name = 'GaAs_QW_2501_14_19_28'
    title_id = os.path.join(date,data_name)
