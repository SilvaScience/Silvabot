...
# %% stich several maps
filenames=['raw_data14_58_49'] # 50 53 57  # 1999Hz : raw_data15_56_53, 499Hz: raw_data15_34_30, 1999 Hz+AC: raw_data16_56_03
maps = {}
rawI = {}
rawQ = {}
amp = {}
...
x0 = 100
dx = 3 
cross_section = np.mean(z[:, x0 - dx: x0 + dx], axis = 1)
