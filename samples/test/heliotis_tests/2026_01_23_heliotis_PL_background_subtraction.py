...
# %%
# input 
date = '2026-01-23' # '2025-07-24' # 
data_name =  'raw_data10_40_38' # 'GaAs_QW_2501_16_08_00' #
bg_name =  'avg_data09_59_51' # 'avg_data17_11_58' # # load background  ;  CHANGE THIS IF TAU CHANGES THE 
...
print('twoD_avgI2',np.max(rawI**2))
print('twoD_avgQ2',np.max(rawQ**2))
