...
# %%
# input 
date = '2026-01-21' # '2025-07-24' # 
data_name =  'raw_data15_19_36' # 'GaAs_QW_2501_16_08_00' #
bg_name =  'avg_data15_09_02' # 'avg_data17_11_58' # # load background  ;  CHANGE THIS IF TAU CHANGES THE 
