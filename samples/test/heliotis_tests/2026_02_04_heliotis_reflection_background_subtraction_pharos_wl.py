...
bg_name =  'avg_data15_55_19' # 1999Hz: avg_data15_55_19, 499Hz: avg_data15_32_59
N_period = 100
freq = 1999
...
# %% stich several maps
filenames=['raw_data15_56_53'] # 50 53 57  # 1999Hz : raw_data15_56_53, 499Hz: raw_data15_34_30
maps = {}
rawI = {}
rawQ = {}
amp = {}
...
I= rawI[file]
Q= rawQ[file]
mean_I = np.mean(I, axis=0)/freq/N_period
mean_Q = np.mean(Q,axis=0)/freq/N_period
